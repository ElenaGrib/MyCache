...
public class TwoLevelCacheClass <KeyType,ValueType extends Serializable> extends Object implements LeveledCache<KeyType,ValueType>{
    ...
    public TwoLevelCacheClass(int _maxRamCacheCapacity, int _numberOfRequestsForRecache)
    {
        ...
        numberOfRequestsForRecache = _numberOfRequestsForRecache;
